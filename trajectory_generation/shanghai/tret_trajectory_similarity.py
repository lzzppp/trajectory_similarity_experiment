...
if __name__ == "__main__":
	...
	index_lat_lon_dataset = pickle.load(open("tert_dataset/porto_grid_lat_lon_time_dataset.pkl", "rb"))
	...
	trainer = EncoderwithDecoderTrainer(model, loss_f, model_params, Dataset, kd, sequences, batch_size=model_params.batch_size, test_batch_size=model_params.test_batch_size, test_trajectory_prob=model_params.test_trajectory_nums)
