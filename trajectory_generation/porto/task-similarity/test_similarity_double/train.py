...
from src.model.model_similarity2 import TERT, trajectory_Distance_Loss
...
if __name__ == "__main__":
    ...
    trainer = EncoderwithDecoderTrainer(model, loss_f, model_params, train_dataset, kd_index, sequences, traj_features,
