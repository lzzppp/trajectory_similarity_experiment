...
def preprocess_trajectory_dataset(Index_Lat_Lon_Dataset, Index_Dict, latitude_unit, longitude_unit, latitude_min,
                                  longitude_min):
    ...
    for trajectory in tqdm(Index_Lat_Lon_Dataset):
        ...
        index_i += 1
    return preprocess_trajectories #, traj_indexs
