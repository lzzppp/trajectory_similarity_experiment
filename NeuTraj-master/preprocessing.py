...
def distance_comp(coor_path):
    ...
    trajecotry_distance_list(np_traj_coord, batch_size=400, processors=30, distance_type=distance_type,
                             data_name=data_name)

    trajectory_distance_combain(8400, batch_size=400, metric_type=distance_type, data_name=data_name)
