...
if __name__ == "__main__":
    ...
    train_lat_lon_dataset = pickle.load(open("/home/xiaoziyang/Downloads/trajectory/porto_grid_lat_lon_time_enough_dataset.pkl", "rb"))
    ...
    trainer = EncoderwithDecoderTrainer(model, params, data=[train_dataset, traj_features], batch_size=batch_size)
