...
if __name__ == "__main__":
    ...
    # init_signal_handler()
    dataloader = DataLoader("/mnt/data4/lizepeng/porto/porto_grid_time_dataset.pkl")
    
    check_data_params(params)
    check_model_params(params)

    params.n_words = 42751  # porto
    ...
    model.load_state_dict(torch.load("/home/lizepeng/trajectory_mass_total_model_best/porto_model/porto_encoder_decoder_35.pth"))
