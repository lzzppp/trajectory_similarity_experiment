...
class EncoderwithDecoderTrainer(object):
    ...
    def get_batch(self):
        ...
        while self.i < len(self.data):
            ...
            tgt_eps = []
            batch_time_data, batch_time_data2 = [], []
            ...
            for j in range(self.i, self.i + self.bacth_size):
                ...
                batch_time_data.append([time_token for time_token in self.data[j][1]])
                ...
                batch_time_data2.append([batch_time_data2[shuffle_index] for shuffle_index in shuffle_token_list])
            ...
            # batch_time_token, batch_time_token2 = [], []
            ...
            batch_time_token = [batch_time_line + (length1_max - len(batch_time_line))*[0] for batch_time_line in batch_time_data]
            batch_time_token2 = [batch_time_line2 + (length2_max - len(batch_time_line2))*[0] for batch_time_line2 in batch_time_data2]
            ...
            yield batch_data_token, batch_data2_token, batch_data_position, batch_data2_position, pred_target, src_mask, tgt_mask, tgt_mask_raw, tgt_forward_mask, length1, batch_time_token, batch_time_token2
    ...
    def mass_road_step(self, epoch):
        ...
        for b_d_token, b_d2_token, b_d_position, b_d2_position, p_target, src_mask, tgt_mask, tgt_mask_raw, tgt_f_mask, length_list, batch_time1, batch_time2 in self.get_batch():
