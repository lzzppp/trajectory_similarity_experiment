...
class EncoderwithDecoderTrainer(object):
    ...
    def mass_road_step(self, epoch):
        ...
        for b_d_token, b_d2_token, b_d_position, b_d2_position, p_target, src_mask, tgt_mask, tgt_f_mask, length_list in self.get_batch():
            ...
            pred_out = self.model(b_d_token, b_d2_token, b_d_position, b_d2_position, tgt_mask=tgt_f_mask, src_key_padding_mask=src_mask, tgt_key_padding_mask=tgt_mask, memory_key_padding_mask=src_mask)
            ...
            del b_d_token, b_d2_token, b_d_position, b_d2_position, p_target, src_mask, tgt_mask, tgt_f_mask, loss
